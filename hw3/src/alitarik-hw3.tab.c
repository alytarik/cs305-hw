...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_tGET = 3,                       /* tGET  */
  YYSYMBOL_tSET = 4,                       /* tSET  */
  YYSYMBOL_tFUNCTION = 5,                  /* tFUNCTION  */
  YYSYMBOL_tPRINT = 6,                     /* tPRINT  */
  YYSYMBOL_tIF = 7,                        /* tIF  */
  ...
  YYSYMBOL_tINC = 13,                      /* tINC  */
  YYSYMBOL_tGT = 14,                       /* tGT  */
  YYSYMBOL_tEQUALITY = 15,                 /* tEQUALITY  */
  YYSYMBOL_tDEC = 16,                      /* tDEC  */
  YYSYMBOL_tLT = 17,                       /* tLT  */
  YYSYMBOL_tLEQ = 18,                      /* tLEQ  */
  YYSYMBOL_tGEQ = 19,                      /* tGEQ  */
  YYSYMBOL_tIDENT = 20,                    /* tIDENT  */
  YYSYMBOL_tNUM = 21,                      /* tNUM  */
  YYSYMBOL_tREAL = 22,                     /* tREAL  */
  YYSYMBOL_tSTRING = 23,                   /* tSTRING  */
  YYSYMBOL_24_ = 24,                       /* '['  */
  YYSYMBOL_25_ = 25,                       /* ']'  */
  YYSYMBOL_26_ = 26,                       /* ','  */
  YYSYMBOL_YYACCEPT = 27,                  /* $accept  */
  YYSYMBOL_stmt_list = 28,                 /* stmt_list  */
  YYSYMBOL_stmts = 29,                     /* stmts  */
  ...
  YYSYMBOL_expr_list = 35,                 /* expr_list  */
  YYSYMBOL_exprs = 36,                     /* exprs  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "tGET", "tSET",
  "tFUNCTION", "tPRINT", "tIF", "tRETURN", "tADD", "tSUB", "tMUL", "tDIV",
  "tINC", "tGT", "tEQUALITY", "tDEC", "tLT", "tLEQ", "tGEQ", "tIDENT",
  "tNUM", "tREAL", "tSTRING", "'['", "']'", "','", "$accept", "stmt_list",
  "stmts", "stmt", "cond", "expr", "param_list", "params", "expr_list",
  "exprs", "return", YY_NULLPTR
};
